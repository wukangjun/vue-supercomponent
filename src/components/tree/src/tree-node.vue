  ...
  <div class="el-tree-node"
    ...
    <div class="el-tree-node__content"
      ...
      <span
        ...
        :class="{ 'is-leaf': node.isLeaf, expanded: !node.isLeaf && expanded,'cv-tree-expand': node.data.type==3}">
      </span>
      <el-checkbox
        v-if="showCheckbox"
        v-model="node.checked"
        :indeterminate="node.indeterminate"
        :disabled="node.data.sumCount>=200?true:false"
