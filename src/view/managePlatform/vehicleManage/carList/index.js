...
export default {
    actions: {
        ...
        // 新增车辆
        insertVehicle({ commit }, params) {
            return http({
                url: COMMON.baseUrl + '/vehicle/insertVehicle',
                data: params
            })
        },
        // 删除单条数据
        ...
        importVehicleFile({ commit }, param) {
            return http({
                url: COMMON.baseUrl + '/terminal/findUnbindTerminalPage',
                params: param
            })
        },
        getVehicleMaster({commit},param){
            return http({
                url: COMMON.baseUrl + '/vehicleMaster/getUnbindMasters',
                params: param
            })
        },
        checkEntUsers({commit}, params){
			return http({
				url: COMMON.baseUrl + '/user/checkEntUserIsAt',
				params: params
			})
        },
        insertVehicleMaster({commit}, params){
			return http({
				url: COMMON.baseUrl + '/vehicleMaster/insertVehicleMaster',
				params: params
			})
		}
    }
