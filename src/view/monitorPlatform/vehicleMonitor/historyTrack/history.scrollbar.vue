	...
	<div class="cv-track-list" ref="bottomDetail" v-show="show">
		<ul class="tab-header bg">
			...
			<li class="tab-head-item toggle-style">
				<cv-play :data='this.$store.getters.trackLists'></cv-play>
			</li>
			<li class="tab-head-item toggle-style">
...
<script>
	...
	import { delegation } from './src/util'
